...
Route::get('/single_product/{id}',[ProductsController::class,'single_product'])->name('single_product');
...
Route::get('/products',[ProductsController::class,'products'])->name('product');
